...
describe("Dashboard Filtering", { tags: ["pre-merge_isolated_bear"] }, () => {
    ...
    it("Update values on edit mode after making change on view mode", () => {
        ...
        new AttributeFilter("Activity Type").open().selectAllValues().apply();
        editMode.save(true);
    ...
    it("Discard changes when editing filter", () => {
        ...
        new AttributeFilter("Activity Type").open().selectAttribute(["Phone Call"]).apply();
    ...
    it("Check attribute filter change value", () => {
        Navigation.visit("dashboard/attribute-filtering");
        editMode.edit();
        new AttributeFilter("Activity Type")
            .open()
            .selectAttribute(["Email", "In Person Meeting", "Phone Call"]);
    ...
    it("Expand and collapse filter", () => {
        Navigation.visit("dashboard/attribute-filtering");
        editMode.edit();
        new AttributeFilter("Activity Type").open().close();
    });
    ...
    it("Verify attribute filter apply button is not disabled", () => {
        ...
        new AttributeFilter("Activity Type").open().selectAllValues().isApplyButtonEnabled(true);
    });
    ...
    it("Verify selected values should be preserved", () => {
        Navigation.visit("dashboard/attribute-filtering");
        dashboardMenu.toggle();
        dashboardHeader.saveAsNew("Clone");
        editMode.edit();
        ...
        new AttributeFilter("Activity Type").open().searchAndSelectFilterItem("Web Meeting").apply();
    ...
    it("Test making no affect on widgets when using unconnected filter", () => {
        ...
        widget
            ...
            .open()
            .openConfiguration()
            .toggleAttributeFilter("Stage Name")
            .close();
    ...
    it("Apply multiple filters on insight", () => {
        Navigation.visit("dashboard/stage-name");
        dashboardMenu.toggle();
        dashboardHeader.saveAsNew("Clone");
        editMode.edit();
